...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            ...
            'Professor': [Permission.FOLLOW, Permission.COMMENT,
...
class Resume(db.Model):
    ...
    user = db.relationship('User', back_populates='resumes', lazy='joined')
...
class User(UserMixin, db.Model):
    ...
    confirmed = db.Column(db.Boolean, default=False)
    # 0: haven't been validated, 1: have been validated, 2: skip
    ...
    # 收藏
    favorite_post = db.relationship('Favorite', back_populates='favoriter', lazy='dynamic', cascade='all, delete-orphan')
    # 消息中心
